...
PDF_RESOURCES = sanitize_resources(
    PDF_RESOURCES,
    ["title", "subject", "unit", "keywords", "drive_link"]
)
YOUTUBE_RESOURCES = sanitize_resources(
    YOUTUBE_RESOURCES,
    ["title", "subject", "unit", "keywords", "youtube_url", "description"]
)
LESSON_SUMMARIES = sanitize_resources(
    LESSON_SUMMARIES,
    ["subject", "title", "unit", "summary"]
)
...
# =========================================================
    ...
    if not PDF_RESOURCES:
        ...
        pdf_item = next((item for item in PDF_RESOURCES if item["title"] == selected_pdf), None)
